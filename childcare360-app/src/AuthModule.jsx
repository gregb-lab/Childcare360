...
export function AuthProvider({ children }) {
  ...
  const logout = async () => {
    ...
    localStorage.removeItem("c360_refresh");
    localStorage.removeItem("c360_tenant");
    localStorage.removeItem("c360_platform_role");
    setUser(null); setTenants([]); setCurrentTenant(null); setPlatformRole(null);
    setAuthScreen("login");
  };
    ...
    <div style={S.page}>
      <div style={S.card}>
        ...
        <form onSubmit={handleLogin}>
          ...
          <button type="submit" disabled={loading} style={{ ...S.btn, ...S.btnPrimary, opacity: loading ? 0.6 : 1 }}>
    ...
    <div style={S.page}>
      <div style={S.card}>
        ...
        <form onSubmit={handleRegister}>
          ...
          <button type="submit" disabled={loading} style={{ ...S.btn, ...S.btnPrimary, marginTop: 8, opacity: loading ? 0.6 : 1 }}>
    ...
    <div style={S.page}>
      <div style={S.card}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" disabled={loading} style={{ ...S.btn, ...S.btnPrimary }}>
    ...
    <div style={S.page}>
      <div style={S.card}>
        ...
        <form onSubmit={handleReset}>
          ...
          <button type="submit" disabled={loading} style={{ ...S.btn, ...S.btnPrimary }}>{loading ? "Resetting..." : "Reset Password"}</button>
        </form>
        <button onClick={() => auth.setAuthScreen("login")} style={{ ...S.link, display: "block", textAlign: "center", marginTop: 12 }}>← Back to login</button>
      </div>
    </div>
    ...
    <div style={S.page}>
      <div style={S.card}>
        ...
        <form onSubmit={handleCreate}>
          ...
          <button type="submit" disabled={loading} style={{ ...S.btn, ...S.btnPrimary, marginTop: 12 }}>
