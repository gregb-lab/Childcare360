...
router.put('/item/:itemId', requireRole('admin','director'), (req, res) => {
...
router.put('/notifications/:id/send', requireRole('admin','director'), (req, res) => {
...
router.post('/scan', requireRole('admin','director'), (req, res) => {
