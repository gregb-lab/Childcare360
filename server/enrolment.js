...
router.get('/applications', requireAuth, requireTenant, requireRole('admin','director'), (req, res) => {
...
router.put('/applications/:id', requireAuth, requireTenant, requireRole('admin','director'), (req, res) => {
